// estimator.v2.js - with improved share input handling and share penalty
(function(global){
  ...
  // === NOVÁ FUNKCE: Zpracování podílu ve všech běžných tvarech ===
  function parseShare(spoluvl, podil) {
    // Pokud není společné vlastnictví, podíl je 1
    ...
    // Desetinné číslo s tečkou nebo čárkou (např. 0.5 nebo 0,5)
    ...
    // Pokud nic nevyhovuje, vrací 1 (nepenalizuje)
    return 1.0;
  }

  // === NOVÁ FUNKCE: Penalizace podílu ===
