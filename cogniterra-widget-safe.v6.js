...
(function(){
  ...
  function addAI(t,extra){ const b=U.el('div',{class:'msg ai'},[t]); if(extra) b.append(extra); chat.append(b); chat.scrollTop=chat.scrollHeight; }
  ...
  async function saveLead(){
    try{
      ...
      }catch(err){ /* necháme doběhnout optimistické potvrzení */ }
