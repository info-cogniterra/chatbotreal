/* Cogniterra Chatbot Widget v2 — LIVE CHAT + CORS-safe + Lead capture */
(function(){
...
${kbText}`}]);
  ...
  async function saveLead(){
    ...
    if(!name||!u.emailOk(email)||!u.phoneOk(phone)){ addAI('Zkontrolujte prosím jméno, e-mail a telefon (formát +420…).'); return; }
    const payload={
